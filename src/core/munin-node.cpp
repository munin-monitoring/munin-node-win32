...
int main(int argc, char* argv[])
{
  ...
  _sntprintf(displayName, 255, _T("Munin Node for Windows %i.%i.%i.%i (Beta)"), ver.GetFileVersionMajor(), ver.GetFileVersionMinor(), ver.GetFileVersionBuild(), ver.GetFileVersionQFE());
